...
function init() {
    ...
    var maxRefreshBySecond = 50;
    var refreshBySecondW = mkTextW($("#refr-output"), 0);
    var refreshRangeW = mkRangeW($("#refr-range"), onRefrRangChange);

    function onRefrRangChange(r) {
        if (r < 0) r = 0;
        if (r > 100) r = 100;
        setRefreshBySecond(maxRefreshBySecond * r / 100);
    }
    ...
    if (debugMode) {
        ...
        setRefreshBySecond(0.6 * maxRefreshBySecond);
    }
}
